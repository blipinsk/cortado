...
public class Unfinished_Or_ViewInteraction_Availability_Tests {

    private Unfinished.Or.ViewInteraction viewInteraction;

    @Before
    public void setup() {
        viewInteraction = Cortado.onView().withText("text").or();
    }
