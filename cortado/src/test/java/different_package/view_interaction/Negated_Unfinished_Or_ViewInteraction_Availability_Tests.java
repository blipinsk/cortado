...
public class Negated_Unfinished_Or_ViewInteraction_Availability_Tests {

    private Negated.Unfinished.Or.ViewInteraction viewInteraction;

    @Before
    public void setup() {
        viewInteraction = Cortado.onView().withText("text").or().not();
    }
